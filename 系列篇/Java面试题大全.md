...
## Java中的异常体系是怎样的
![image.png](./img/rQ74o8W65QSsoCPH/1695274034795-52b82cbb-b6e2-40b4-8586-1057fa2c1a55-577531.png)
...
![1690204763239-0a36e926-3b2a-40d0-821b-429ac925e563.jpeg](./img/rQ74o8W65QSsoCPH/1690204763239-0a36e926-3b2a-40d0-821b-429ac925e563-897673.jpeg)

 
以下两个类型是相等的，表面泛型被擦除了，都是ArrayList
![image.png](./img/rQ74o8W65QSsoCPH/1690198625500-1a5cfb9b-de48-4ce8-88ad-fc73a6897b11-215090.png)

以下API，只能拿到泛型的个数，不能拿到具体的泛型类型
![image.png](./img/rQ74o8W65QSsoCPH/1690198875882-a806955a-7613-4cb1-bc4b-c40781c2958b-513141.png)


通过放射可以往List添加不同类型的元素，因为类型其实被擦除了，变成了Object
![image.png](./img/rQ74o8W65QSsoCPH/1690199113277-e7b32550-e3e3-4e86-b2c1-4847b615a797-994046.png)



泛型虽然被擦除了，但是具体的泛型信息还是被保存在了字节码中
![image.png](./img/rQ74o8W65QSsoCPH/1690199450688-73573112-c70c-4e4d-9694-11dce711d9cb-923813.png)

所以还是有一些方式可以很方便的获取到泛型的真实类型的
![image.png](./img/rQ74o8W65QSsoCPH/1690204026748-814cb0a1-3cce-4be3-9224-0d994281976f-983015.png)
![image.png](./img/rQ74o8W65QSsoCPH/1690204033411-b32de53b-8bdf-462c-be63-9957ab8021a3-345588.png)
![image.png](./img/rQ74o8W65QSsoCPH/1690204051908-3f65da0b-5e7f-410e-80fe-f2aee29dbe2f-250558.png)

另外，对于JVM，如果对每个泛型类型都生成不同的目标代码，假如现在有10个不同泛型的List，就要生成10份字节码，这样会造成不仅造成代码膨胀，而且一份字节码对应一个Class对象，占据大量的内存。

## Java中有哪些类加载器
![image.png](./img/rQ74o8W65QSsoCPH/1695284933934-d95c0fda-b61f-4fe2-900d-6aab251605a4-079983.png)
...
![1622816824404-17d018de-eb06-41eb-9936-64e4c6cc046d.png](./img/rQ74o8W65QSsoCPH/1622816824404-17d018de-eb06-41eb-9936-64e4c6cc046d-204114.png)
...
![1622816023795-3ae4931c-bcab-4e8c-a987-4fecf53f9855.png](./img/rQ74o8W65QSsoCPH/1622816023795-3ae4931c-bcab-4e8c-a987-4fecf53f9855-676311.png)
...
![ReentrantLock公平锁加锁.png](./img/rQ74o8W65QSsoCPH/1626185425264-6d9a8ab7-12d9-4032-8fa4-1bcc40231009-772418.png)                                                   ![ReentrantLock非公平锁加锁.png](./img/rQ74o8W65QSsoCPH/1626185427450-d6a6ab8e-94a4-4e7a-be68-bab2d06b320c-223141.png)
...
![Bean的生命周期.png](./img/rQ74o8W65QSsoCPH/1625729452241-4bc1dbb0-a827-49f1-83b8-70e61fd29a65-499012.png)
...
![1622966825505-41961ccc-19e0-4f70-8182-e6e3337eb3af.png](./img/rQ74o8W65QSsoCPH/1622966825505-41961ccc-19e0-4f70-8182-e6e3337eb3af-511805.png)
...
![1622965863563-ce71fb30-d01f-4829-93a8-a94d784ccc2c.png](./img/rQ74o8W65QSsoCPH/1622965863563-ce71fb30-d01f-4829-93a8-a94d784ccc2c-849922.png)



## Spring用到了哪些设计模式

![Spring中的设计模式.png](./img/rQ74o8W65QSsoCPH/1638187280609-2738d2ba-22f1-4107-9c0f-9c7a8144dcba-747018.png)
...
索引情况：
![image.png](./img/rQ74o8W65QSsoCPH/1676441269905-beaa3167-d54b-459f-81b2-8511fa98d205-826884.png)
a字段是主键，对应主键索引，bcd三个字段组成一个联合索引，e字段一个索引

### 1. 不符合最左匹配原则
![image.png](./img/rQ74o8W65QSsoCPH/1676440676093-add4ff6a-d422-4f40-b3cb-b37e47649586-927672.png)

去掉b=1的条件就不符合最左匹配原则了，导致所有失效
![image.png](./img/rQ74o8W65QSsoCPH/1676440694138-21cb9f9e-62fd-4407-8a59-35dac67b4bb0-137972.png)

### 2. 不正确的Like查询
不用like能走索引：
![image.png](./img/rQ74o8W65QSsoCPH/1676441388985-dd894fe7-5e62-4963-82d0-f35527244b5a-803901.png)
正常使用like：
![image.png](./img/rQ74o8W65QSsoCPH/1676441439769-58372ca6-248e-4751-8d33-516c484eb3e4-583795.png)
不正确使用like：
![image.png](./img/rQ74o8W65QSsoCPH/1676441454918-10d3d846-cb50-49a6-b27d-7d581e47cf6e-958059.png)


### 3. 对索引列进行了计算或使用了函数
![image.png](./img/rQ74o8W65QSsoCPH/1676441511562-24c5629c-7592-46fc-ada6-8cb799f74565-445385.png)

![image.png](./img/rQ74o8W65QSsoCPH/1676441536615-677899cc-8abb-481a-85b6-61b58ea76179-656376.png)

### 4. 索引列进行了类型转换

e字段的类型是vachar，下面这个sql需要把e字段中的字符转换成数字，会导致索引失效
![image.png](./img/rQ74o8W65QSsoCPH/1676441574914-0b982490-b3cb-45ab-a5f5-9b92380e78dc-988225.png)

### 5. <>不等于导致索引失效

b=1可以走索引，b<>1就不能走索引
![image.png](./img/rQ74o8W65QSsoCPH/1676441625277-08d21740-9d77-485f-9915-3f43e703cfe2-290642.png)

### 6. order by导致索引失效

就算利用索引，但是由于是select * 所以需要回表，而且回表成本比较高，所以不会走索引。
![image.png](./img/rQ74o8W65QSsoCPH/1676442107674-6566e5ed-784a-4325-9869-a9ad0b8bb6e6-902006.png)

如果是select b就需要回表了，就会选择走索引
![image.png](./img/rQ74o8W65QSsoCPH/1676442170113-f7ec872a-ddb1-4183-b477-131b056fb588-444495.png)

### 7. 使用or导致索引失效

![image.png](./img/rQ74o8W65QSsoCPH/1676442219810-663f0bb0-5ed1-4cac-b93d-be3eaf7452e2-440812.png)

### 8. select * 导致索引失效
![image.png](./img/rQ74o8W65QSsoCPH/1676442285345-6dce4534-c3dc-4348-b712-c1ec27164afb-586466.png)
...
![image.png](./img/rQ74o8W65QSsoCPH/1676443326948-a9f418ab-1606-47ab-9ebd-618fde89d761-383390.png)
...
![未命名文件.png](./img/rQ74o8W65QSsoCPH/1668599070561-7707946a-4402-48e1-8dad-63169f07d2b0-292366.png)
...
![未命名文件 (1).png](./img/rQ74o8W65QSsoCPH/1668599322284-46fcb513-6e94-46d0-845e-3c69378854ad-451815.png)
...
![image.png](./img/rQ74o8W65QSsoCPH/1671959484035-6355ab75-49c9-4197-92eb-48f7615c0aae-289348.png)
...
会发现，这个sql会走bcd联合索引
![image.png](./img/rQ74o8W65QSsoCPH/1671960159223-f31eea23-3b5a-49e0-ab1e-a44c4e7b966e-594864.png)
...
2. 缓存击穿：和缓存雪崩类似，缓存雪崩是大批热点数据失效，而缓存击穿是指某一个热点key突然失效，也导致了大量请求直接访问Mysql数据库，这就是缓存击穿，解决方案就是考虑这个热点key不设过期时间![image.png](./img/rQ74o8W65QSsoCPH/1673876566077-e90007d2-41ec-4158-b6c2-2bb51b455ecb-443560.png)
...
![image.png](./img/rQ74o8W65QSsoCPH/1673876513755-d29f5617-1937-484d-ad49-7bb26cc3c51f-622800.png)
...
![1626176708107-3ad83a45-25b3-403e-beaf-02185e787ff9.jpeg](./img/rQ74o8W65QSsoCPH/1626176708107-3ad83a45-25b3-403e-beaf-02185e787ff9-309032.jpeg)
...
## 雪花算法原理
![image.png](./img/rQ74o8W65QSsoCPH/1627449092303-9281aa79-94f4-4eae-9ddc-22e5b53eed2e-567491.png)
...
## RocketMQ的事务消息是如何实现的
![image.png](./img/rQ74o8W65QSsoCPH/1627371194711-08b1bccb-cebb-4aa8-ae4d-14932f6dee74-046332.png)
...
![1625820731086-61084cde-5942-4121-b7bb-a0a06e95d2b1.gif](./img/rQ74o8W65QSsoCPH/1625820731086-61084cde-5942-4121-b7bb-a0a06e95d2b1-378960.gif)                        ![1625820737332-3edf976d-4def-464d-9eee-e41ea3a0c5a4.gif](./img/rQ74o8W65QSsoCPH/1625820737332-3edf976d-4def-464d-9eee-e41ea3a0c5a4-024451.gif)
...
![1668258325801-576d4ca1-5a5b-4f4a-b91d-ecabdaaaeb8e.jpeg](./img/rQ74o8W65QSsoCPH/1668258325801-576d4ca1-5a5b-4f4a-b91d-ecabdaaaeb8e-061078.jpeg)
...
![1668513379681-00f7ed75-e093-4688-9b9a-cfd9ac16fe9c.jpeg](./img/rQ74o8W65QSsoCPH/1668513379681-00f7ed75-e093-4688-9b9a-cfd9ac16fe9c-761521.jpeg)
...
![cap.jpg](./img/rQ74o8W65QSsoCPH/cap-361310.jpeg)
CAP定理是由三次单词组成：
...
![1670317738162-e224abb6-ea76-479c-a861-4e762f47d2a9.png](./img/rQ74o8W65QSsoCPH/1670317738162-e224abb6-ea76-479c-a861-4e762f47d2a9-842259.png)
