...
![image.png](./img/5qugRobAjAfsQDRg/1676269727038-37cea301-05dd-49ce-b4f6-44c46c928e71-905819.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676272667331-ca4b8fc4-edcb-42cd-9700-6e21bdf10180-178154.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676273586231-499379c4-3560-4068-85e7-d493e2348a55-452081.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676275218059-b16761b8-2a89-4c55-b086-71b2d9f3518b-436967.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676275530469-eb977793-c45f-4b96-abf3-89f640b40978-820613.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676278755475-df3c35f2-2873-4d70-a7db-7e238cdeda74-067184.png)
**在Java语言里，类型的加载、连接、初始化都是在程序运行期间完成的**，这种策略让类加载时稍微增加一些性能开销，但也为Java应用提供了高度的灵活性，Java天生可以动态扩展的语言特性就是基于运行期动态加载和动态连接这个特点实现的。
![image.png](./img/5qugRobAjAfsQDRg/1676288531247-d5e8b424-6c84-45a7-8833-4c8f2bfa7f1a-084451.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676294726195-64d33024-fad7-47be-b688-da92abf77f4a-895912.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676275218059-b16761b8-2a89-4c55-b086-71b2d9f3518b-059174.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676296871408-aec02d9f-3a31-4026-8909-3c1b3c7b2307-641628.png)
...
## ![image.png](./img/5qugRobAjAfsQDRg/1676297449792-a4466261-c7fc-471f-9e84-7ccbb8501a93-207436.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676297827844-b8b18a65-2f61-4d84-a796-4d7532b21980-435166.png)
而在 G1 回收器中，其将一大块的内存分为许多细小的区块，从而不要求内存是连续的。
![image.png](./img/5qugRobAjAfsQDRg/1676297852174-82fbe74a-6dfc-4b42-81eb-df3965f56e84-105342.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676297939163-380db39b-cd5a-44ab-9c7b-eb3006acac9a-849988.png)
...
```
![image.png](./img/5qugRobAjAfsQDRg/1676384465582-a78d9deb-02bd-48ff-acef-1b793ad8fc14-835695.png)
上面是基于JDK17截图的Java工具集，已经删除了VisualVM了，在此我们基于GCEasy来进行GC日志分析。
官网地址为：[https://gceasy.io/](https://gceasy.io/) 它有在线分析版和离线分析版都可以使用～
![image.png](./img/5qugRobAjAfsQDRg/1676428403161-5343ed7a-03c1-4615-958a-5437567f8bc7-739685.png)
![image.png](./img/5qugRobAjAfsQDRg/1676428420180-92b5abf8-95dc-41a1-a892-2293b467c0f6-474781.png)
![image.png](./img/5qugRobAjAfsQDRg/1676428559138-e2f84021-9997-4e17-aedd-135315bae9cd-803942.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676436830572-a4c98ac1-d0a2-4ed7-bfb7-a73910e9a399-279941.png)**如果满足下面的指标，则一般不需要进行GC：**
...
![image.png](./img/5qugRobAjAfsQDRg/1676441513929-a7697ba9-b216-4caf-a66d-0dc643a1b9a0-898343.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676441560935-7b39505f-975d-449b-ac41-075bfb72eab0-269127.png)
再点击 **See stacktrace** 看看线程栈基本就能定位到问题代码了。
![image.png](./img/5qugRobAjAfsQDRg/1676441706641-97e93eb0-5171-4136-b809-3fe104e44f79-443683.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676441747206-bea2c4d8-9929-4e98-8c77-f58cebb0a622-100695.png)
在 char[] 上点击右键，选择 List objects -> with incoming references，就可以列出所有的 char[] 实例，以及每个 char[] 的整个引用关系链：
![image.png](./img/5qugRobAjAfsQDRg/1676441803299-ac553c3f-36a3-40d8-8733-e41d03d8fdac-746602.png)
随机展开一个 char[]，如下图所示：
...
![image.png](./img/5qugRobAjAfsQDRg/1676441899977-56ec56a4-9b45-465f-927b-e7e084baa5a0-504044.png)
如果希望看到完整内容的话，可以右键选择 Copy->Value，把值复制到剪贴板或保存到文件中：
![image.png](./img/5qugRobAjAfsQDRg/1676442169987-eb6d407c-a195-460a-9d36-e01007fa0132-637095.png)

### 线程栈 — 分析代码
可以点击工具栏的第五个按钮，打开线程视图来分析 OOMTest 执行什么逻辑。
![image.png](./img/5qugRobAjAfsQDRg/1676442272122-46a63b21-8606-4426-af85-4cc6d86704ab-474018.png)
...
![image.png](./img/5qugRobAjAfsQDRg/1676442463614-91a9ff67-657d-47ab-a9e1-d92daa5a4c87-135820.png)
输入 help 命令，可以看到所有支持的命令列表。这里主要会用到 dashboard、thread、jad、watch 等命令，来定位高CPU的问题。
![image.png](./img/5qugRobAjAfsQDRg/1676442472775-c02c8b23-d965-4239-a4ed-ab45b7ae7454-216486.png)

### dashboard — 展示整体情况
`dashboard` 命令整体展示了进程所有线程、内存、GC 等情况，可以明显看到两个CPU占用很高的线程，从线程名字来看应该是线程池的线程。

### ![image.png](./img/5qugRobAjAfsQDRg/1676442500149-11acdae1-3a9d-4827-9a46-42c42bbb9da7-517539.png)
thread — 查看高CPU的线程
...
### ![image.png](./img/5qugRobAjAfsQDRg/1676442524872-f961b41c-2cc3-4cd9-9a02-f961262a3452-311906.png)
watch — 监控参数
如果想要观察方法的入参和出参，可以用 watch 命令来观察：
![image.png](./img/5qugRobAjAfsQDRg/1676442544685-14990973-8ca7-4da3-b9db-4cc82581bde6-005280.png)

### jad — 反编译
![image.png](./img/5qugRobAjAfsQDRg/1676442586243-178f29ca-5727-463a-9f27-057e68d9d110-377395.png)

### redefine — 重载类
如果我们想做线上调试，又不想在本地改代码，打印日志，再提交到服务器，再重启服务测试，那我们可以结合 arthas 的 jad、mc、redefine 来动态重定义类。
1、首先用 jad 把源文件下载下来
![image.png](./img/5qugRobAjAfsQDRg/1676442606124-15203759-1ba1-4f02-80d2-011e172e0bef-562978.png)
然后修改下源码：添加了一行输出日志
![image.png](./img/5qugRobAjAfsQDRg/1676442613630-d9b074e2-fd52-4dca-9477-81ee8427be9a-111496.png)
2、使用 mc 命令反编译源文件
反编译后会生成对应的 class 文件：
![image.png](./img/5qugRobAjAfsQDRg/1676442625034-d370af5d-3ed0-4d4c-a668-8a32ee9410f2-173301.png)
3、使用 redefine 重载类
![image.png](./img/5qugRobAjAfsQDRg/1676442632993-34ae6142-c5e9-4724-93a1-44d07391b594-155374.png)
就可以看到控制台已经在输出我们打印的日志了：
![image.png](./img/5qugRobAjAfsQDRg/1676442639581-37cbe452-00e4-4371-bda7-2d56985d33d2-227761.png)
